 ...
 */
@Embeddable
public class RipsCtPK implements Serializable {
    ...
    public RipsCtPK(int idRipAlmacenado, int numRegistro) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RipsCtPK)) {
            return false;
        }
        RipsCtPK other = (RipsCtPK) object;
    ...
    public String toString() {
        return "modelo.entidades.RipsCtPK[ idRipAlmacenado=" + idRipAlmacenado + ", numRegistro=" + numRegistro + " ]";
    }
