 ...
 */
@Embeddable
public class RipsApPK implements Serializable {
    ...
    public RipsApPK(int idRipAlmacenado, int numRegistro) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RipsApPK)) {
            return false;
        }
        RipsApPK other = (RipsApPK) object;
    ...
    public String toString() {
        return "modelo.entidades.RipsApPK[ idRipAlmacenado=" + idRipAlmacenado + ", numRegistro=" + numRegistro + " ]";
    }
