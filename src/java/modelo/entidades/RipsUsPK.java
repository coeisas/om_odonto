 ...
 */
@Embeddable
public class RipsUsPK implements Serializable {
    ...
    public RipsUsPK(int idRipAlmacenado, int numRegistro) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RipsUsPK)) {
            return false;
        }
        RipsUsPK other = (RipsUsPK) object;
    ...
    public String toString() {
        return "modelo.entidades.RipsUsPK[ idRipAlmacenado=" + idRipAlmacenado + ", numRegistro=" + numRegistro + " ]";
    }
