 ...
 * @author santos
 */
public class EstructuraFacturaAdministradora {//Datos principales para una factura de administradora
    ...
    private List<EstructuraItemsAdministradora> listaItemsFactura;
    ...
    public List<EstructuraItemsAdministradora> getListaItemsFactura() {
        return listaItemsFactura;
    }

    public void setListaItemsFactura(List<EstructuraItemsAdministradora> listaItemsFactura) {
